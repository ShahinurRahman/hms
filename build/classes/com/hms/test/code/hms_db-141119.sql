...
insert  into `discount_doctor_patient`(`DOCTOR_ID`,`PATIENT_ID`) values (2,52),(2,53),(2,54),(2,55),(2,57),(4,16),(4,18),(4,56),(5,14),(5,15),(5,49);
...
insert  into `user`(`id`,`password`,`username`) values (1,'admin','admin'),(2,'user','user'),(3,'superadmin','superadmin'),(4,'123','abc');
...
insert  into `user_create`(`id`,`password`,`userName`) values (1,'admin','admin'),(2,'user','user'),(3,'superadmin','superadmin');
